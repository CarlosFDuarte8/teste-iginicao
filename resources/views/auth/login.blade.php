...
@section('content')
    <div class="col-md-10 text-center ml-auto mr-auto">
        <h3 class="mb-5">Faça login para ver como você pode gerenciar ou criar perfis.</h3>
    </div>
    <div class="col-lg-4 col-md-6 ml-auto mr-auto">
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-white">
                ...
                <div class="card-body">
                    <p class="text-dark mb-2">Entre com <strong>admin@duarte.com</strong> e a senha <strong>secret</strong></p>
                    ...
                    <div class="input-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                        ...
                        <input type="password" placeholder="{{ _('Password') }}" name="password" class="form-control{{ $errors->has('Senha') ? ' is-invalid' : '' }}">
