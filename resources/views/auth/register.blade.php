@extends('layouts.app', ['class' => 'register-page', 'page' => _('Pagina de resgistro'), 'contentClass' => 'register-page'])
                ...
                <form class="form" method="post" action="{{ route('register') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                            ...
                            <input type="email" name="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ _('E-mail') }}" value="{{ old('email') }}">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" name="password_confirmation" class="form-control" placeholder="{{ _('Confirme a Senha') }}">
                        </div>
