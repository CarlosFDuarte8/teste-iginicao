            ...
            -->
                <li class="dropdown nav-item">
                    ...
                    <ul class="dropdown-menu dropdown-navbar">
                        <li class="nav-link">
                            <a href="{{ route('profile.edit') }}" class="nav-item dropdown-item"><i class="tim-icons icon-single-02"></i>{{ __('Perfil') }}</a>
                        </li>
                        <li class="nav-link">
                            <a href="#" class="nav-item dropdown-item"><i class="tim-icons icon-settings-gear-63"></i>{{ __('Configurações') }}</a>
                        </li>
                        <li class="dropdown-divider"></li>
                        <li class="nav-link">
                            <a href="{{ route('logout') }}" class="nav-item dropdown-item" onclick="event.preventDefault();  document.getElementById('logout-form').submit();"><i class="tim-icons icon-button-power"></i>{{ __('Sair') }}</a>
                        </li>
                    </ul>
                </li>
